    ...
    <div className="container mx-auto py-12 px-4 max-w-3xl">
      ...
      <Card className="shadow-xl border-primary/20 hover:shadow-2xl transition-shadow">
        <CardHeader className="text-center border-b pb-6 border-border">
            ...
            <CardTitle className="text-3xl font-bold tracking-tight text-foreground">Privacy Policy</CardTitle>
        ...
        <CardContent className="pt-6 space-y-6 prose dark:prose-invert max-w-none text-foreground/90">
          ...
          <h2 className="text-2xl font-semibold pt-4 border-t mt-6 border-border text-foreground">1. Information Collection and Use</h2>
          <p>We collect several different types of information for various purposes to provide and improve our Service to you.</p>
          
          <h3 className="text-xl font-semibold mt-4 text-foreground">Types of Data Collected:</h3>
          ...
          <h2 className="text-2xl font-semibold pt-4 border-t mt-6 border-border text-foreground">2. Use of Data</h2>
          ...
          <h2 className="text-2xl font-semibold pt-4 border-t mt-6 border-border text-foreground">3. Data Storage, Transfer, and Security</h2>
          ...
          <h2 className="text-2xl font-semibold pt-4 border-t mt-6 border-border text-foreground">4. Service Providers</h2>
          ...
          <h2 className="text-2xl font-semibold pt-4 border-t mt-6 border-border text-foreground">5. Your Data Protection Rights</h2>
          ...
          <h2 className="text-2xl font-semibold pt-4 border-t mt-6 border-border text-foreground">6. Children&apos;s Privacy</h2>
          ...
          <h2 className="text-2xl font-semibold pt-4 border-t mt-6 border-border text-foreground">7. Changes to This Privacy Policy</h2>
          ...
          <h2 className="text-2xl font-semibold pt-4 border-t mt-6 border-border text-foreground">8. Contact Us</h2>
          <p>If you have any questions about this Privacy Policy, please contact us:</p>
          <ul className="list-disc space-y-1 pl-5">
            <li>By email: <a href="mailto:privacy@fuelflex.example.com" className="text-primary hover:underline hover:text-accent">privacy@fuelflex.example.com</a></li>
            <li>By visiting this page on our website: <Link href="/contact" className="text-primary hover:underline hover:text-accent">fuelflex.example.com/contact</Link></li>
          </ul>
        </CardContent>
      </Card>
    </div>
