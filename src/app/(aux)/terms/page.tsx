  ...
  return (
    <div className="container mx-auto py-12 px-4 max-w-3xl">
      ...
      <Card className="shadow-xl border-primary/20 hover:shadow-2xl transition-shadow">
        <CardHeader className="text-center border-b pb-6 border-border">
          <div className="inline-block p-4 bg-primary/10 rounded-full ring-4 ring-primary/20 mb-4">
            <FileText className="h-16 w-16 text-primary" />
          </div>
          <CardTitle className="text-3xl font-bold tracking-tight text-foreground">Terms of Service</CardTitle>
          <CardDescription className="text-lg text-muted-foreground mt-1">Please read these terms carefully.</CardDescription>
        </CardHeader>
        <CardContent className="pt-6 space-y-6 prose dark:prose-invert max-w-none text-foreground/90">
          ...
          <h2 className="text-2xl font-semibold pt-4 border-t mt-6 border-border text-foreground">1. Acceptance of Terms</h2>
          ...
          <h2 className="text-2xl font-semibold pt-4 border-t mt-6 border-border text-foreground">2. Services Provided</h2>
          ...
          <h2 className="text-2xl font-semibold pt-4 border-t mt-6 border-border text-foreground">3. User Accounts and Registration</h2>
          ...
          <h2 className="text-2xl font-semibold pt-4 border-t mt-6 border-border text-foreground">4. Goods Listing, Transport Bookings, and Payments</h2>
          <h3 className="text-xl font-semibold mt-3 text-foreground">For Sellers:</h3>
          ...
          <h3 className="text-xl font-semibold mt-3 text-foreground">For Buyers/Shippers:</h3>
          ...
          <h3 className="text-xl font-semibold mt-3 text-foreground">For Transport Owners:</h3>
          ...
          <h3 className="text-xl font-semibold mt-3 text-foreground">Payments:</h3>
          ...
          <h2 className="text-2xl font-semibold pt-4 border-t mt-6 border-border text-foreground">5. User Conduct and Prohibited Uses</h2>
          ...
          <h2 className="text-2xl font-semibold pt-4 border-t mt-6 border-border text-foreground">6. Intellectual Property</h2>
          ...
          <h2 className="text-2xl font-semibold pt-4 border-t mt-6 border-border text-foreground">7. Disclaimers and Limitation of Liability</h2>
          ...
          <h2 className="text-2xl font-semibold pt-4 border-t mt-6 border-border text-foreground">8. Indemnification</h2>
          ...
          <h2 className="text-2xl font-semibold pt-4 border-t mt-6 border-border text-foreground">9. Governing Law</h2>
          ...
          <h2 className="text-2xl font-semibold pt-4 border-t mt-6 border-border text-foreground">10. Changes to Terms</h2>
          <p>We reserve the right, at our sole discretion, to modify or replace these Terms at any time. If a revision is material, we will provide at least 30 days&apos; notice prior to any new terms taking effect. What constitutes a material change will be determined at our sole discretion.</p>
          <p>By continuing to access or use our Service after any revisions become effective, you agree to be bound by the revised terms. If you do not agree to the new terms, you are no longer authorized to use the Service.</p>

          <h2 className="text-2xl font-semibold pt-4 border-t mt-6 border-border text-foreground">11. Contact Us</h2>
          <p>If you have any questions about these Terms, please contact us:</p>
          <ul className="list-disc space-y-1 pl-5">
            <li>By email: <a href="mailto:legal@fuelflex.example.com" className="text-primary hover:underline hover:text-accent">legal@fuelflex.example.com</a></li>
             <li>By visiting our contact page: <Link href="/contact" className="text-primary hover:underline hover:text-accent">fuelflex.example.com/contact</Link></li>
          </ul>
        </CardContent>
      </Card>
    </div>
